...
Testing for null and throwing an exception is needed at all. If widget isn't tested for null, it will still throw a NullPointerException. But here's a different case, where a test for null is much more important:
